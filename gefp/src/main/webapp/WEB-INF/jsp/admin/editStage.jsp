									...
									<div class="panel-body" id="section" style="width: 100%">
										<div class="table-responsive">
											<table class="table table-striped" border='1'
												...
												<tr>
													<td>Stage Name:</td>
													<td><input type="text" id="oldstage" name="stage"
														value="${stage}" class="form-control"></td>
												</tr>
												<tr>
													<td>New Stage Name:</td>
													<td><input type="text" id="newstage"
														name="newstage" value="" class="form-control"></td>
												</tr>
												...
												<tr>
													<td><input type="hidden" name="dname"
														...
														type="hidden" name="stageid" value="${stageid}">
													</td>
