		...
		<div id="page-wrapper">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<th><a
							href="view.html?dname=${departmentname}">Back</a></th>
					</div>
					<form:form modelAttribute="plan" method="POST" action="create.html">
						<div class="row">
							<div class="col-lg-12">
								<!--    Striped Rows Table  -->
								<div class="panel panel-default">
									<div class="panel-heading"style=" background-color: #D8D1D4;"><font size="3" color="black" ><strong>Add Plan</strong></font></div>
									<div class="panel-body" id="section" style="width:100%">
										<div class="table-responsive">
											<table class="table table-striped" border="1">
												...
												<tr>
												<td>	
													<input type="hidden" value="${departmentid.id}"
														name="departmentid" />
													<input type="hidden" value="${departmentid.name}"
														name="departmentname" /></td>
													<td align="right"><input type="submit" name="save"
														value="Add Plan" class="btn btn-primary" /></td>
												</tr>
											</table>
										</div>
									</div>
