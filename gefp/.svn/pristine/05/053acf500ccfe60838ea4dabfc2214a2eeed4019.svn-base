			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="row">
						...
						<form:form  method="POST" action="resetpassword.html" modelAttribute="user">
							<div class="row">
								<div class="col-lg-12">
									<!--    Striped Rows Table  -->
											...
											<div class="table-responsive">
												...
												<table class="table table-striped" border="1" width="100%"
													...
													<tr>
														...
														<tr>
															<td>New Password :</td>
															<td><input type="text" value="" name="nwpsd" /></td>
														</tr>
														<tr>
															<td colspan="2"><input type="submit" name="savepassword" value="Save Password" class="btn btn-primary"/></td>
