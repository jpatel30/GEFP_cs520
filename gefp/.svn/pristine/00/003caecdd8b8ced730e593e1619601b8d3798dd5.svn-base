			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="row">
						...
						<form:form method="POST" action="changedepartment.html">
							<div class="row">
								<div class="col-lg-12">
									<!--    Striped Rows Table  -->
										...
										<div class="panel-body">
											<div class="table-responsive">
												...
												<table class="table table-striped" border="1" width="100%"
													...
													<td width="580"><select name="Department"
														class="form-control">
													...
													<tr>
														<td colspan="2"><input type="submit"
															name="changedepartment" value="Change Department" class="btn btn-primary" /></td>
