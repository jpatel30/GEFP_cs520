				...
				<div class="col-lg-12">
					...
					<th><a
							...
							<form:form modelAttribute="stage" method="POST"
								action="addstage.html">
								<div class="row">
									<div class="col-lg-12">
										<!--    Striped Rows Table  -->
										<div class="panel panel-default">
											<div class="panel-heading"style=" background-color: #D8D1D4;"><font size="3" color="black" ><strong>Add Stage</strong></font></div>
													...
													<table class="table table-striped" border="1">
														...
														<td>	
															...
															<td align="right"><input type="submit" name="save"
																value="Add Stage" class="btn btn-primary" /></td>
														</tr>
													</table>
												</div>
											</div>
